WITH base AS (
    ...
    FROM {{ ref('estimation_18_flags') }}
    UNION ALL
    SELECT RESULT_TIME,name,type,subject_age,verification_status,reported_age,time_in_seconds,actually_allowed_18 as actually_allowed,estimated_allowed_18 as estimated_allowed
