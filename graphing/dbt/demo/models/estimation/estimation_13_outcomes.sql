WITH base AS (
    ...
    FROM {{ ref('estimation_13_flags') }}
    UNION ALL
    SELECT RESULT_TIME,name,type,subject_age,verification_status,reported_age,time_in_seconds,actually_allowed_13 as actually_allowed,estimated_allowed_13 as estimated_allowed
